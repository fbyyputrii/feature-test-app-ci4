        ...
        $(document).ready(function() {
            ...
            $('#passwordToggle').click(function() {
                if ($password.attr('type') === 'password') {
                    ...
                    $(this).find('.toggle-icon').addClass('show-password');
                } else {
                    $password.attr('type', 'password');
                    $(this).find('.toggle-icon').removeClass('show-password');
                }
            });
            ...
            function showError(field, msg) {
                $('#' + field + 'Error').text(msg).addClass('show');
                $('#' + field).closest('.form-group').addClass('error');
            }

            function clearError(field) {
                $('#' + field + 'Error').text('').removeClass('show');
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        if (res.status === 'success') {
                            ...
                            showError('password', res.message || 'Login gagal');
                        }
                    },
                    error: function() {
                        setLoading(false);
                        showError('password', 'Server error / koneksi gagal');
                    }
                });
            });
